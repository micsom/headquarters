...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/headquarters)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/headquarters
```

A live public deployment of this template is available at [https://headquarters.templates.workers.dev](https://headquarters.templates.workers.dev)
